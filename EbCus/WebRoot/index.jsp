...
<html>
  ...
  <body>
        ...
        <div id="nav" class="page-container">
            ...
            <div class="login-area">
                <ul class="logined">
                    ...
                    <li class="my_message">
                    	<a href="getMessageTo.do?url=message_box.jsp" target="_blank" 
                    		onmousemove="msgMoveto()" onmouseout="msgMoveOff()">我的通知
                    	</a>
                    </li>
                    <li class="user_card"><a href="javascrpt:void(0)" onmousemove="personMoveto()" >我的账户</a></li>
                </ul>
            </div>
        </div>
        <div class="headerfor">
                        ...
                        <div class="submenu">
                            <div class="leftdiv">
                                <dl>
                                    <dt><a href="#">热门搜索</a></dt>
                                    <dd>
                                        <a href="javascript:void(0)" onclick="queryBookByName1('java')">Java</a>
                                        <a href="#">Linux</a>
                                        <a href="#">Python</a>
                                        <a href="#">PHP</a>
                                        <a href="#">Android</a>
    ...
    <div class="foot"></div>
     <div class="person" style="display:none" id="person">
        <ur onMouseUp="personMoveOffc()" >
            <div class="person_first"><a href="javacript:void(0)">我的账户</a></div>
            <li><a href="getTourl.do?url=person_page.jsp" target="_blank">个人资料</a></li>
            <li><a href="getTourl.do?url=address_form.jsp" target="_blank">收货地址</a></li>
            <li><a href="getOrderTo.do?url=order_form.jsp" target="_blank">订单信息</a></li>
        </ur>
    </div>
    <div class="msg" id="msg" style="display:none">
        <span><br><br>
            &nbsp;&nbsp;尊敬的${user.username},您有${total}未读信息。
        </span>
    </div>
</body>
</html>
